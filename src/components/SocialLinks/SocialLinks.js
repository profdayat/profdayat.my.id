...
class Component extends React.PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        <A
          href="https://twitter.com/prof_dayat"
          title="Twitter"
          target="twitter"
        >
          <span className="mdi mdi-twitter" />
        </A>
        <A href="https://github.com/profdayat" title="Github" target="github">
          <span className="mdi mdi-github-circle" />
        </A>
        <A
          href="https://www.instagram.com/prof.dayat"
          title="Instagram"
          target="instagram"
        >
        ...
        <A
          href="https://www.linkedin.com/in/profdayat"
          title="LinkedIn"
          target="linkedin"
        >
          <span className="mdi mdi-linkedin" />
        </A>
        <A href="mailto:akundayat97@gmail.com" title="Email" target="email">
